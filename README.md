...
| 🧰 Инструмент | ⚰️ Через сколько сломается | ❌ Теряет долговечность | ➖ Никакого эффекта |
| :--- | :--- | :--- | :--- |
| Непрочный топор | 40 ударов по 🌲 | Ударить дерево/камень (даже если нет предмета) | Взмах и промах |
| Непрочная лопата | 40 вскапываний 🕳 | Ударьте по камню (даже если нет предмета)<br>Выкопайте/выкорчевайте что-нибудь | Выкопайте пустую яму<br>Заполните яму |
| Непрочная удочка | 10 пойманных 🐠 | Поймать рыбу либо мусор | Неудачный заброс |
| Непрочный сачок | 10 жуков 🐛 | Поймать жука | Неудачный взмах<br>Попасть по кому-то |
| Непрочная лейка | ~20 поливаний 🌷 | Водяные цветы | |
</details>
